...
export default function SignUpPage() {
  ...
  const handleGoogleSignup = () => {
    ...
    alert('Google signup coming soon! Please use manual signup for now.');
  };

  const handleManualSignup = () => {
    setIsLoading(true);
    // Smooth transition to manual signup
    setTimeout(() => {
      router.push('/auth/signup/manual');
    }, 100);
  };
        ...
        <div className="max-w-sm mx-auto w-full">
          ...
          <div className="mb-12">
            ...
            <div className="text-center">
              <h1 className="text-5xl font-bold text-black mb-6 leading-tight">
                Your wellness journey, beautifully illuminated
              </h1>
              <p className="text-lg text-gray-600 mb-2">
                Choose your signup option to get started
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-16">
            ...
            <Button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-lg shadow-sm transition-all duration-200 flex items-center justify-center space-x-3"
            >
            ...
            >
              {isLoading ? 'Loading...' : 'Sign up manually'}
            </Button>
          </div>
